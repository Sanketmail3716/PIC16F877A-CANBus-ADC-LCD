#line 1 "G:/My Drive/Envision/PIC Microcontroller/MikroC/CAN/Three_Node_2ADC/Second_node2/Second_node.c"
...
long Rx_ID;
unsigned int received_value, own_adc_value;
char txt[16];
...
void main() {
 ...
 if ((Rx_ID == ID_1st) && Msg_Rcvd && Rx_Data_Len == 2) {
 ...
 Lcd_Out(2,11,"     ");
#line 73 "G:/My Drive/Envision/PIC Microcontroller/MikroC/CAN/Three_Node_2ADC/Second_node2/Second_node.c"
 }
