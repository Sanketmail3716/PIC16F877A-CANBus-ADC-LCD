...
;Third_node3.c,35 :: 		void Display_Value(unsigned int value, char row, char col) {
;Third_node3.c,36 :: 		Lcd_Out(row, col, "    "); // Clear old value
	MOVF       FARG_Display_Value_row+0, 0
	MOVWF      FARG_Lcd_Out_row+0
	MOVF       FARG_Display_Value_col+0, 0
	MOVWF      FARG_Lcd_Out_column+0
	MOVLW      ?lstr1_Third_node3+0
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;Third_node3.c,37 :: 		Lcd_Chr(row, col+0, value/1000 + '0');
	MOVF       FARG_Display_Value_row+0, 0
	...
	CALL       _Lcd_Chr+0
;Third_node3.c,38 :: 		Lcd_Chr(row, col+1, (value/100)%10 + '0');
	MOVF       FARG_Display_Value_row+0, 0
	MOVWF      FARG_Lcd_Chr_row+0
	...
	MOVWF      FARG_Lcd_Chr_out_char+0
	CALL       _Lcd_Chr+0
;Third_node3.c,39 :: 		Lcd_Chr(row, col+2, (value/10)%10 + '0');
	MOVF       FARG_Display_Value_row+0, 0
	MOVWF      FARG_Lcd_Chr_row+0
	MOVLW      2
	...
	MOVWF      FARG_Lcd_Chr_out_char+0
	CALL       _Lcd_Chr+0
;Third_node3.c,40 :: 		Lcd_Chr(row, col+3, value%10 + '0');
	MOVF       FARG_Display_Value_row+0, 0
	MOVWF      FARG_Lcd_Chr_row+0
	MOVLW      3
	ADDWF      FARG_Display_Value_col+0, 0
...
;Third_node3.c,43 :: 		void main() {
;Third_node3.c,44 :: 		ADCON1 = 0x80; // Configure AN0-AN1 as analog
	MOVLW      128
	MOVWF      ADCON1+0
;Third_node3.c,45 :: 		TRISA = 0xFF;  // AN1 input on RA1
	MOVLW      255
	MOVWF      TRISA+0
;Third_node3.c,47 :: 		SPI1_Init();
	CALL       _SPI1_Init+0
;Third_node3.c,48 :: 		Lcd_Init();
	CALL       _Lcd_Init+0
;Third_node3.c,49 :: 		Lcd_Cmd(_LCD_CLEAR);
	MOVLW      1
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;Third_node3.c,50 :: 		Lcd_Cmd(_LCD_CURSOR_OFF);
	MOVLW      12
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;Third_node3.c,53 :: 		Can_Send_Flags = _CANSPI_TX_PRIORITY_0 & _CANSPI_TX_XTD_FRAME & _CANSPI_TX_NO_RTR_FRAME;
	MOVLW      244
	MOVWF      _Can_Send_Flags+0
;Third_node3.c,56 :: 		_CANSPI_CONFIG_VALID_XTD_MSG & _CANSPI_CONFIG_LINE_FILTER_OFF;
	MOVLW      209
	MOVWF      _Can_Init_Flags+0
;Third_node3.c,58 :: 		CANSPIInitialize(1,3,3,3,1,Can_Init_Flags);
	MOVLW      1
...
;Third_node3.c,59 :: 		CANSPISetOperationMode(_CANSPI_MODE_CONFIG,0xFF);
	MOVLW      128
	MOVWF      FARG_CANSPISetOperationMode_mode+0
	MOVLW      255
	MOVWF      FARG_CANSPISetOperationMode_WAIT+0
	CALL       _CANSPISetOperationMode+0
;Third_node3.c,60 :: 		CANSPISetMask(_CANSPI_MASK_B1,-1,_CANSPI_CONFIG_XTD_MSG);
...
;Third_node3.c,61 :: 		CANSPISetMask(_CANSPI_MASK_B2,-1,_CANSPI_CONFIG_XTD_MSG);
	MOVLW      1
	...
	MOVWF      FARG_CANSPISetMask_CANSPI_CONFIG_FLAGS+0
	CALL       _CANSPISetMask+0
;Third_node3.c,62 :: 		CANSPISetFilter(_CANSPI_FILTER_B2_F3,ID_2nd,_CANSPI_CONFIG_XTD_MSG);
	MOVLW      4
...
;Third_node3.c,63 :: 		CANSPISetOperationMode(_CANSPI_MODE_NORMAL,0xFF);
	CLRF       FARG_CANSPISetOperationMode_mode+0
	MOVLW      255
	MOVWF      FARG_CANSPISetOperationMode_WAIT+0
	CALL       _CANSPISetOperationMode+0
;Third_node3.c,65 :: 		while(1){
L_main0:
;Third_node3.c,70 :: 		Msg_Rcvd = CANSPIRead(&Rx_ID, RxTx_Data, &Rx_Data_Len, &Can_Rcv_Flags);
	MOVLW      _Rx_ID+0
	...
	MOVF       R0+0, 0
	MOVWF      _Msg_Rcvd+0
;Third_node3.c,71 :: 		if ((Rx_ID == ID_2nd) && Msg_Rcvd && Rx_Data_Len == 2) {
	MOVF       _Rx_ID+3, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L__main9
...
L__main9:
	...
	GOTO       L_main4
L__main6:
;Third_node3.c,72 :: 		received_value = ((unsigned int)RxTx_Data[0] << 8) | RxTx_Data[1];
	MOVF       _RxTx_Data+0, 0
...
;Third_node3.c,73 :: 		Lcd_Out(2,1,"RXD3:");
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
	MOVLW      ?lstr2_Third_node3+0
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;Third_node3.c,80 :: 		Display_Value(received_value, 2, 6);
	MOVF       _received_value+0, 0
...
;Third_node3.c,81 :: 		received_value = ADC_Read(0); // 10-bit ADC
	...
	MOVF       R0+1, 0
	MOVWF      _received_value+1
;Third_node3.c,83 :: 		RxTx_Data[0] = received_value>> 8;     // MSB
	MOVF       R0+1, 0
	MOVWF      R2+0
	CLRF       R2+1
	MOVF       R2+0, 0
	MOVWF      _RxTx_Data+0
;Third_node3.c,84 :: 		RxTx_Data[1] = received_value & 0xFF;   // LSB
	MOVLW      255
	ANDWF      R0+0, 0
	MOVWF      _RxTx_Data+1
;Third_node3.c,85 :: 		CANSPIWrite(ID_2nd, RxTx_Data, 2, Can_Send_Flags);
	MOVLW      113
	...
	CALL       _CANSPIWrite+0
;Third_node3.c,86 :: 		Lcd_Out(1,1,"TXD3:");
	MOVLW      1
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
	MOVLW      ?lstr3_Third_node3+0
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;Third_node3.c,93 :: 		Display_Value(received_value, 1, 6);
	MOVF       _received_value+0, 0
	MOVWF      FARG_Display_Value_value+0
	MOVF       _received_value+1, 0
	MOVWF      FARG_Display_Value_value+1
