#line 1 "G:/My Drive/Envision/PIC Microcontroller/MikroC/CAN/Three_Node_2ADC/Third_node3/Third_node3.c"
...
void main() {
 ...
 Lcd_Out(2,1,"RXD3:");
#line 80 "G:/My Drive/Envision/PIC Microcontroller/MikroC/CAN/Three_Node_2ADC/Third_node3/Third_node3.c"
 Display_Value(received_value, 2, 6);
 received_value = ADC_Read(0);

 RxTx_Data[0] = received_value>> 8;
 RxTx_Data[1] = received_value & 0xFF;
 CANSPIWrite(ID_2nd, RxTx_Data, 2, Can_Send_Flags);
 Lcd_Out(1,1,"TXD3:");
#line 93 "G:/My Drive/Envision/PIC Microcontroller/MikroC/CAN/Three_Node_2ADC/Third_node3/Third_node3.c"
